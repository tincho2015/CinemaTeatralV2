...
public class altaDeTeatro extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.abm_teatro);

        nombre = findViewById(R.id.editTextNombreT);
        telefono = findViewById(R.id.editTextTelefonoT);
        direccion = findViewById(R.id.editTextDireccionT);
        barra = findViewById(R.id.progressBar);
        teatroid = findViewById(R.id.editTextTeatroID);
        urlTeatro = findViewById(R.id.editTextURL);

        ListaTeatros = new ArrayList<>();

        teatros = findViewById(R.id.listViewTeatros);
    ...
    class teatroAdapter extends ArrayAdapter<teatro> {
        ...
        public teatroAdapter(List<teatro> teatroList) {
            super(altaDeTeatro.this, R.layout.activity_listar_teatros, teatroList);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            textViewDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(altaDeTeatro.this);
    ...
    private void refrescarLista(JSONArray teatros) throws JSONException {
        ...
        teatroAdapter adapter = new teatroAdapter(ListaTeatros);
